...
- `approval_token` 由 `logdog.llm.permissions.issue_approval_token(...)`、`issue_approval_token_for_policy(...)` 或外部审批系统按同样签名规则生成，并与具体工具参数绑定
